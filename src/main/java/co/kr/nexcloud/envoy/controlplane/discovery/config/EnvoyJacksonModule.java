package co.kr.nexcloud.envoy.controlplane.discovery.config;
...
public class EnvoyJacksonModule extends Module {
	  private final ProtobufJacksonConfig config;
	  
	  private SimpleDeserializers deserializers;

	  public EnvoyJacksonModule() {
	    this(ProtobufJacksonConfig.builder().build());
	    deserializers = new SimpleDeserializers();
	  }
	  
	  public SimpleDeserializers getDeserializers() {
		  return deserializers;
	  }

	  public EnvoyJacksonModule(ProtobufJacksonConfig config) {
	    this.config = config;
	  }
...
//	    deserializers.addDeserializer(Filter.class, new ListenerFilterDeserializer());
//	    deserializers.addDeserializer(Cluster.class, new ClusterDeserializer());
